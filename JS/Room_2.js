class Room_2 extends Phaser.Scene {
	...
	preload(){
		this.load.image("background",("../resources/levels/level_1/room_2/background_f.png"));
		this.load.image("bg",("../resources/levels/level_1/room_2/bg.png"))
		this.load.image("terrain",("../resources/levels/level_1/room_2/room_2.png"));
		this.load.tilemapTiledJSON("map","../resources/levels/level_1/maps/room_2_tilemap.json")
	...
	create(){
		...
		*/
		...
		let terrain = map.addTilesetImage("room_2","terrain");
