class Room_3 extends Phaser.Scene {
	...
	preload(){
		this.load.image("background",("../resources/levels/level_1/room_3/background_f.png"));
		this.load.image("bg",("../resources/levels/level_1/room_3/bg.png"))
		this.load.image("terrain",("../resources/levels/level_1/room_3/room_3.png"));
		this.load.tilemapTiledJSON("map","../resources/levels/level_1/maps/room_3_tilemap.json")
	...
	create(){
		...
		*/
		...
		let character = this.character = this.physics.add.sprite(350,800,"character");
		...
		let terrain = map.addTilesetImage("room_3","terrain");
		...
		this.physics.add.collider(this.character,rightExitLayer,() =>{
