class Room_5 extends Phaser.Scene {
	...
	preload(){
		this.load.image("background",("../resources/levels/level_1/room_5/background_f.png"));
		this.load.image("bg",("../resources/levels/level_1/room_5/bg.png"))
		this.load.image("terrain",("../resources/levels/level_1/room_5/room_5.png"));
		this.load.tilemapTiledJSON("map","../resources/levels/level_1/maps/room_5_tilemap.json")
	...
	create(){
		...
		*/
		...
		let background = map.addTilesetImage("backgrounds", "background");
		let terrain = map.addTilesetImage("room_5","terrain");
